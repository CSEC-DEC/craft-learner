    ...
    <div className='h-screen flex'>
      <div className="flex w-full bg-white text-deep-purple flex-col gap-6 justify-center items-center p-4">
        ...
        <div className='text-2xl text-white flex flex-nowrap justify-center gap-4'>
          <div className='bg-my-green w-[15em] h-[10em] p-4 flex flex-col items-start rounded-lg border-t-[3px] border-l-[3px] border-r-[5px] border-b-[5px] hover:border-r-[6px] hover:border-b-[6px] hover:cursor-pointer border-black'>
            <h1>icon</h1>
